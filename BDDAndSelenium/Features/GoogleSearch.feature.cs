...
namespace BDDAndSelenium.Features
{
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Google search BDD with Selenium")]
        [NUnit.Framework.TestCaseAttribute("Chrome", Category="Chrome", TestName="GoogleSearchBDDWithSelenium on Chrome")]
        [NUnit.Framework.TestCaseAttribute("IE", Category="IE", TestName="GoogleSearchBDDWithSelenium on IE")]
        [NUnit.Framework.TestCaseAttribute("Firefox", Category="Firefox", TestName="GoogleSearchBDDWithSelenium on Firefox")]
        public virtual void GoogleSearchBDDWithSelenium(string browser)
        {
            InitializeSelenium(browser);
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Google search BDD with Selenium", new string[] {
                        "Browser:Chrome",
                        "Browser:IE",
                        "Browser:Firefox"});
#line 7
